                   ...
                   <div class="row">
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-6 form-group">
                           ...
                           <asp:TextBox ID="RolNumber" class="form-control" runat="server" ControlToValidate="txtNumberos" ErrorMessage="Ingrese Numeros" ValidationExpression="\d+"></asp:TextBox>
                       </div>
                   </div>
                </div>
