<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EjemploGrid.aspx.cs" Inherits="WebFinal.Contact" %>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4" style="background-color: #bbb">
                <h1>Columna 2</h1>
                <p>
                    Esto es una prueba de bootstrap.
                </p>
            </div>
